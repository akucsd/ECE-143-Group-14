...
2. Installing the runGA Package

A. Change to the directory that contains the file setup.py and the subdirectory runGA. If 
...
3. Using the runGA Package

The runGA package is on your Python path. To import it into a Python script or session, 
execute:
